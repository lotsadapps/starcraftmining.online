...
async function initContract() {
  if (!this.contract) {
    this.contract = await new web3.eth.Contract(abi, "0x0B9315D8AF5A475B50FB78490B1B58A3E6B27F57");
  }
